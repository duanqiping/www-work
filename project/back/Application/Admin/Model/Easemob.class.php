...
class Easemob extends Model{
    private $debug = true;
    private $client_id = 'YXA6Bk9MoGw7EeePi-VXy21arQ';
    private $client_secret = 'YXA6J7yUJ8tuKHZIIp0cxNp8-_11yd8';

    private $org_name = '1188170719178735';
    private $app_name = 'sport';//;
    private $url = '';
//------------------------------------------------------用户体系	
		/**
	 * 初始化参数
