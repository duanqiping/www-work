        ...
        <div class="data-table table-striped">
            <table class="" style="clear:both;height:0;width:0;border-collapse:separate; border-spacing:60px 10px;">
                ...
                <?php if(!empty($_list)): if(is_array($_list)): $i = 0; $__LIST__ = $_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                            ...
                            <td><a href="<?php echo U('info',array('contest_id'=>$vo['contest_id']));?>" style="color: #0000C0">人员名单</a></td>
                            <!--<td><?php echo ($vo['is_show']?'正常':'禁用'); ?></td>-->
                            <!--<td><?php echo ($vo['count']); ?><a href="">查看详情</a></td>-->
                        </tr><?php endforeach; endif; else: echo "" ;endif; ?>
                    <?php else: ?>
                    <!--<td colspan="11" class="text-center"> aOh! 暂时还没有内容! <a href="<?php echo U('user',array('contest_id'=>$vo['contest_id']));?>" style="color: red">点击添加学生</a> </td>-->
                    <td colspan="11" class="text-center"> aOh! 暂时还没有内容! <a href="<?php echo U('user',array('contest_sn'=>$contest_sn));?>" style="color: red">点击添加学生</a> </td><?php endif; ?>
                </tbody>
