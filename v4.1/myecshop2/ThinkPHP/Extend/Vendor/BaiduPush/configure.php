...
class BAIDU_PUSH_CONFIG {
     ...
     * @var string
     */
    const default_apiKey = 'GyewxZKwklSdtOgAfz3tUzb4';//ios
//    const default_apiKey = 'N7okVPmX3GGEWUzMe5veYpHQ';//安卓
     ...
     * @var string
     */
    const default_secretkey = 'NigCwl1PKaH78gakdzX4GDtyU3ytAulO';//ios
//    const default_secretkey = 'qtsawbPU4GLr2Uo2zBDqdTP20VHfLny4';//安卓
