...
<div id="wrapper">
    ...
    <div class="main">
        <div class="main-title" style="margin-left: 60px;margin-top: 10px">
            <h2>add</h2>
        </div>
        <div style="margin-left: 60px;margin-top: 10px">
            <form action="<?php echo U();?>" method="post">
                赛事标题：<input type="text" name="title" /><br/>
                赛事描述：<input type="text" name="desc" /><br/>
                赛事长度：<input type="text" name="length" /><br/>

                开始时间：<input type="text" name="begin_time" class="some_class" value="" /><br/>
                结束时间：<input type="text" name="end_time" class="some_class" value="" /><br/>
...
<script type="text/javascript">
    ...
    <script src="/project/back/Public/Admin/js/jquery.datetimepicker.full.js"></script>
    <script type="text/javascript">
