...
class EasemobModel extends Model{
    ...
    //注意：pcwstore对应的正式服务器           pcwstore-dev对应的阿里云服务器
//	private $client_id = 'YXA6Sv-IQEfIEeW48kU2oKfnaQ';//'YXA64FLgoEfHEeWUTyX4s9Q5Pg';
//	private $client_secret = 'YXA6f7Rz16EO7AJYuNnVfpA793DnK8Q';//'YXA6cMmJ5WY9z8PzmA2ZxBXnAX99m6o';
//	private $org_name = 'senpng';
//	private $app_name = 'pcwstore-dev';//'pcwstore';
//	private $url = '';

    private $client_id = 'YXA64FLgoEfHEeWUTyX4s9Q5Pg';
    private $client_secret = 'YXA6cMmJ5WY9z8PzmA2ZxBXnAX99m6o';
    private $org_name = 'senpng';
    private $app_name = 'pcwstore';//'pcwstore';
    private $url = '';
...
/*		$this->client_id = 'YXA64Ry_8B38EeWGLzn8jUkxxg';//isset ( $options ['client_id'] ) ? $options ['client_id'] : '';
		$this->client_secret = 'YXA63U4S68-NvXLqpduJQ5oHGYk7Ln0';//isset ( $options ['client_secret'] ) ? $options ['client_secret'] : '';
		$this->org_name = 'senpng';//isset ( $options ['org_name'] ) ? $options ['org_name'] : '';
		$this->app_name = 'pcw365';//isset ( $options ['app_name'] ) ? $options ['app_name'] : '';*/
