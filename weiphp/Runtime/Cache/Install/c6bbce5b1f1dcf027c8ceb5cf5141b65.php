...
<html>
    <head>
        ...
        <link href="/weiphp/Public/Install/css/install.css?v=<?php echo SITE_VERSION;?>" rel="stylesheet">
        ...
        <script src="/weiphp/Public/static/bootstrap/js/bootstrap.js?v=<?php echo SITE_VERSION;?>"></script>
    </head>
            ...
            <div class="navbar-inner">
                <div class="container">
                    ...
                    <div class="nav-collapse collapse">
                    	<p class="install_logo"><span><img width="50px;" src="/weiphp/Public/Install/img/install.png"/></span></p>
