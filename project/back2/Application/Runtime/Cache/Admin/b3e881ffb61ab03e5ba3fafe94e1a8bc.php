...
<div id="wrapper">
        ...
        <div class="sidebar-scroll">
            <nav>
                <ul class="nav">
                    ...
                    <li><a href="#" class=""><i class="lnr lnr-cog"></i> <span>成绩管理</span></a></li>
                    <li><a href="#" class=""><i class="lnr lnr-alarm"></i> <span>排行榜</span></a></li>

                    <li><a href="#" class=""><i class="lnr lnr-dice"></i> <span>考试/赛事</span></a></li>
    ...
    <div class="main">
        ...
        <span style="color: #0000cc">设备运行状态：</span><span>正常运行</span><br/>

        <form id="formid"  name= "myform" method = 'post'  action = 'report'>
