...
<div id="wrapper">
    ...
    <div class="main">
        ...
        <form action="<?php echo U('score');?>" method="post">
...
<script type="text/javascript">
    ...
    <script type="text/javascript">
        var ajaxurldept = "<?php echo U('getSection');?>"; // merchant.js 中使用
        var ajaxurlclass = "<?php echo U('getCatid');?>"; // merchant.js 中使用
    </script>
