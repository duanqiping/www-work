...
<div id="wrapper">
    ...
    <div class="main">
        ...
        <form action="<?php echo U('info');?>" method="post">
            ...
            <!--<input type="hidden" name="contest_sn" value="<?php echo ($contest_sn); ?>">-->
            <!-- 数据列表 -->
            <div class="data-table table-striped" style="margin-top: 10px">
                ...
                <table class=""  style="clear:both;height:0;width:0;border-collapse:separate; border-spacing:60px 10px;">
                    ...
                    <?php if(!empty($_list)): if(is_array($_list)): $k = 0; $__LIST__ = $_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;?><tr>
                                <td><input class="ids" type="checkbox" name="id[]" value="<?php echo ($vo["user_id"]); ?>" /></td>
...
<script type="text/javascript">
    ...
    <script type="text/javascript">
        var ajaxurldept = "<?php echo U('customer/getSection');?>"; // merchant.js 中使用
        var ajaxurlclass = "<?php echo U('customer/getCatid');?>"; // merchant.js 中使用
    </script>
    <script src="/project/back/Public/Admin/js/linkage.js"></script>
    <script src="/project/back/Public/Admin/js/common.js"></script>
