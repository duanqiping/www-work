...
<div id="wrapper">
    ...
    <div class="main">
        ...
        <table class="" style="border-collapse:separate; border-spacing:60px 10px;">
            <thead>
                <tr>
                    ...
                    <th class="">开机时间</th>
                    <th class="">下一个机器</th>
                    <th class="">上个机器有效时间</th>
                    <th class="">故障报销</th>
                </tr>
            </thead>
            <tbody>
            <?php if(!empty($device)): if(is_array($device)): $i = 0; $__LIST__ = $device;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                        <td><?php echo ($vo["ms_code"]); ?> </td>
                        <td><?php echo ($vo["status"]); ?></td>
                        <td><?php echo (date("Y-m-d H:m:s",$vo["add_time"])); ?></td>
                        <td><?php echo ($vo["next_ms_code"]); ?></td>
                        <td><?php echo ($vo["last_expire_time"]); ?></td>
                        <td>故障报销</td>
        ...
        <br/><br/><br/><br/>
        <div style="margin-left: 60px">
            <span>待处理的工单</span>&nbsp&nbsp&nbsp&nbsp <span>处理中的工单</span>&nbsp&nbsp&nbsp&nbsp
            <span>处理完成的工单</span>&nbsp&nbsp&nbsp&nbsp<span>确认完成的工单</span>
        </div>
        ...
        <!--<a href="<?php echo U('customer/report');?>" style="color: #660000">障碍报修</a><br/>-->
