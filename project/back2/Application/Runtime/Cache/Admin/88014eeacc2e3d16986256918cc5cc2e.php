...
<div id="wrapper">
    ...
    <div class="main">
        <div>
            <span class="number">总用户数量：</span>
            <span class="title"><?php echo ($data["count"]); ?></span>
        </div>
        <div>
            <span class="number">活跃用户数量：</span>
            <span class="title"><?php echo ($data["count_month"]); ?></span>
        </div>
        <div>
            <span class="number">单圈最佳：</span>
            <span class="title"><?php echo ($data["best_single"]); ?> 秒</span>
        </div>
        <div>
            <span class="number">用户总公里数：</span>
            <span class="title"><?php echo ($data["sum_length"]); ?> km</span>
        </div>
        <div>
            <span class="number">每天活跃量：</span>
            <span class="title"><?php echo ($data["count_day"]); ?></span>
        </div>
        <div>
            <span class="number">月跑步公里数</span>
            <span class="title"><?php echo ($user["max_length"]); ?> km</span>
        </div>
        <div>
            <span class="number">用户时间段统计</span>
            <span class="title"><?php echo ($user["max_length"]); ?> km</span>
        </div>
        <div>
            <span class="number">持续运动量</span>
            <span class="title"><?php echo ($user["max_length"]); ?> km</span>
        </div>
        <div>
            <span class="number">消息推送有天赋的运动员</span>
            <span class="title"><?php echo ($user["max_length"]); ?> km</span>
        </div>
    </div>
