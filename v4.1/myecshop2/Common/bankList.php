...
function getBankInfos($card,$bankList)
{
    $card_8 = substr($card, 0, 8);
    if (isset($bankList[$card_8])) {
        return array($card_8,$bankList[$card_8]);
    }
    $card_6 = substr($card, 0, 6);
    if (isset($bankList[$card_6])) {
        return array($card_6,$bankList[$card_6]);
    }
    $card_5 = substr($card, 0, 5);
    if (isset($bankList[$card_5])) {
        return array($card_5,$bankList[$card_5]);
    }
    $card_4 = substr($card, 0, 4);
    if (isset($bankList[$card_4])) {
        return array($card_4,$bankList[$card_4]);
    }
    return '该卡号信息暂未录入';
}

//储蓄卡 -- 获取银行卡图标
function getDrCodeAndImg2($bankname)
{
    $res = '';
    if(preg_match('/农业银行/i',$bankname))
    {
       return $res = NROOT.'/myecshop2/Public/bank_icon/ABC.png';
    }
    if(preg_match('/中国银行/i',$bankname))
    {
       return $res = NROOT.'/myecshop2/Public/bank_icon/BOCB2C.png';
    }
    if(preg_match('/平安银行/i',$bankname))
    {
       return $res = NROOT.'/myecshop2/Public/bank_icon/SPABANK.png';
    }
    if(preg_match('/广发银行/i',$bankname))
    {
       return $res = NROOT.'/myecshop2/Public/bank_icon/GDB.png';
    }
    if(preg_match('/浦东发展银行/i',$bankname))
    {
       return $res = NROOT.'/myecshop2/Public/bank_icon/SPDB.png';
    }
    if(preg_match('/交通银行/i',$bankname))
    {
       return $res = NROOT.'/myecshop2/Public/bank_icon/COMM.png';
    }
    if(preg_match('/光大银行/i',$bankname))
    {
       return $res = NROOT.'/myecshop2/Public/bank_icon/CEB.png';
    }
    if(preg_match('/兴业银行/i',$bankname))
    {
       return $res = NROOT.'/myecshop2/Public/bank_icon/CIB.png';
    }
    if(preg_match('/工商银行/i',$bankname))
    {
       return $res = NROOT.'/myecshop2/Public/bank_icon/ICBCB2C.png';
    }
    if(preg_match('/招商银行/i',$bankname))
    {
       return $res = NROOT.'/myecshop2/Public/bank_icon/CMB.png';
    }
    if(preg_match('/建设银行/i',$bankname))
    {
       return $res = NROOT.'/myecshop2/Public/bank_icon/CCB.png';
    }
    if(preg_match('/中国邮储银行/i',$bankname))
    {
       return $res = NROOT.'/myecshop2/Public/bank_icon/POSTGC.png';
    }
    if(preg_match('/民生银行/i',$bankname))
    {
       return $res = NROOT.'/myecshop2/Public/bank_icon/CMBC.png';
    }
    return $res;
...
//信用卡 -- 获取银行卡图标
function getCrCodeAndImg2($bankname)
{
    $res = '';
    if(preg_match('/农业银行/i',$bankname))////////////////////////////////////
    {
    ...
    if(preg_match('/东亚银行/i',$bankname))
    {
        return $res = NROOT . '/myecshop2/Public/bank_icon/HKBEA.png';
    }
    if(preg_match('/南昌银行/i',$bankname))
    {
        return $res = NROOT . '/myecshop2/Public/bank_icon/NCC.png';
    }
    if(preg_match('/宁波银行/i',$bankname))
    {
        return $res = NROOT . '/myecshop2/Public/bank_icon/NBCB.png';
    }
    if(preg_match('/花旗银行/i',$bankname))
    {
        return $res = NROOT . '/myecshop2/Public/bank_icon/CITI.png';
    }
    if(preg_match('/华夏银行/i',$bankname))
    {
        return $res = NROOT . '/myecshop2/Public/bank_icon/HXB.png';
    }
    if(preg_match('/北京银行/i',$bankname))
    {
        return $res = NROOT . '/myecshop2/Public/bank_icon/BCCB.png';
    }
    if(preg_match('/广发银行/i',$bankname))
    {
        return $res = NROOT . '/myecshop2/Public/bank_icon/GDB.png';
    }
    if(preg_match('/包商银行/i',$bankname))
    {
        return $res = NROOT . '/myecshop2/Public/bank_icon/BSB.png';
    }
    if(preg_match('/兰州银行/i',$bankname))
    {
        return $res = NROOT . '/myecshop2/Public/bank_icon/LZ.png';
    }
    if(preg_match('/南京银行/i',$bankname))
    {
        return $res = NROOT . '/myecshop2/Public/bank_icon/NJCB.png';
    }
    if(preg_match('/潍坊银行/i',$bankname))
    {
        return $res = NROOT . '/myecshop2/Public/bank_icon/WFCCB.png';
    }
    if(preg_match('/杭州银行/i',$bankname))
    {
        return $res = NROOT . '/myecshop2/Public/bank_icon/HCCB.png';
    }
    if(preg_match('/温州银行/i',$bankname))
    {
        return $res = NROOT . '/myecshop2/Public/bank_icon/WZCB.png';
    }
    if(preg_match('/上饶银行/i',$bankname))
    {
        return $res = NROOT . '/myecshop2/Public/bank_icon/SR.png';
    }
    if(preg_match('/上海农商银行/i',$bankname))
    {
        return $res = NROOT . '/myecshop2/Public/bank_icon/SHRCB.png';
    }
    if(preg_match('/河北银行/i',$bankname))
    {
        return $res = NROOT . '/myecshop2/Public/bank_icon/HEB.png';
    }
    if(preg_match('/中信银行/i',$bankname))
    {
        return $res = NROOT . '/myecshop2/Public/bank_icon/CITIC.png';
    }
    if(preg_match('/上海银行/i',$bankname))
    {
        return $res = NROOT . '/myecshop2/Public/bank_icon/BOS.png';
    }
    if(preg_match('/江苏银行/i',$bankname))
    {
        return $res = NROOT . '/myecshop2/Public/bank_icon/JSB.png';
    }
...
//获取麦网支持的银行卡卡信息
function getMaiWangBankList($banktype)
{
    $key = KEY;
    ...
    $post_data['merchantCode'] = $merchantcode;//商户编号
...
//    $post_data['url'] = S_URL;//商户请求地址
//    $post_data['key'] = KEY;//商户加密key
    $post_data['bankCardType'] = $banktype;//银行卡类型
    $post_data['bankCode'] = '';//
    ...
    // post数据
    curl_setopt($ch, CURLOPT_TIMEOUT,10);   //超时设置(秒) 只需要设置一个秒的数量就可以
    curl_setopt($ch, CURLOPT_POST, 1);
    // post的变量
    curl_setopt($ch, CURLOPT_POSTFIELDS, $post_data);

    $output = json_decode(curl_exec($ch));//转成对象
    return $output->bankList;
}
