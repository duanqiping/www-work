...
<div id="wrapper">
    ...
    <div class="main">
        ...
        <div style="margin-left: 60px">
            <!--<span>单圈最佳排行</span>&nbsp&nbsp&nbsp&nbsp <span>马拉松排行</span>&nbsp&nbsp&nbsp&nbsp-->
            <!--<span>周排行</span>&nbsp&nbsp&nbsp&nbsp<span>月排行</span>&nbsp&nbsp&nbsp&nbsp<span>年排行</span>-->
            <!--<button id="single" class="btn ajax-post" url="<?php echo U('changeStatus?method=resumeUser');?>" target-form="ids">单圈最佳排行</button> <button id="marathon">马拉松排行</button>-->
            <a href="<?php echo U('rank',array('flag'=>'single'));?>">单圈最佳排行</a>&nbsp&nbsp&nbsp&nbsp
        </div>
        <div style="margin-left: 60px;margin-top: 10px">
            <div style="float: left">
                <select id="week" name="cycles">
                    <!--<OPTGROUP LABEL="周排行">-->
                    <option>周排行</option>
                    <option>1圈</option>
                    <option>2圈</option>
            ...
            <div style="float: left">
                <select id="marathon" name="cycles">
                    <!--<OPTGROUP LABEL="周排行">-->
                    <option>马拉松排行</option>
                    <option>四分之一程马拉松</option>
                    <option>半程马拉松</option>
                    <option>全程马拉松</option>
                </select>
            </div>
        ...
        <br/><br/>
        <h5 style="margin-left: 60px;margin-top: 10px;color: #0000C0"><?php echo ($rankName); ?>排行榜</h5>
        <!-- 数据列表 -->
        <div class="data-table table-striped">
            <table class="" style="clear:both;height:0;width:0;border-collapse:separate; border-spacing:60px 10px;">
                ...
                <tbody>
                <?php if(!empty($_list)): if(is_array($_list)): $k = 0; $__LIST__ = $_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;?><tr>
...
<script type="text/javascript">
    ...
    <script src="/project/back/Public/Admin/js/linkage.js"></script>
    <script src="/project/back/Public/static/jquery-2.0.3.min.js"></script>

    <script type="text/javascript">
        var rankUrl = "<?php echo U('rank');?>"; // merchant.js 中使用
    </script>
